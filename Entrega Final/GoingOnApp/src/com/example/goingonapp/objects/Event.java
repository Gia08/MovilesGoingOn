...
public class Event {
	 ...
	 *   
	 */
	public Event(String mId, String name,  String description, String startDate, String endDate, String startTime, String endTime, String eventPrice, int idTypeEvent, int idTypePrivacyEvent, int idTypeStateEvent, double latitude, double longitude, String Username) {
		this.mId = mId;
		this.name = name;
	...
	public Event(String nombreEvento, String descripcionEvento, String id, double Lat, double Long, int idTypeEvent) {
